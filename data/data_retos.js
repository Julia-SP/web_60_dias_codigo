...
const data_retos = [
  {
    ...
    descripcion_corta: "Landing page atractiva y responsive que presenta el reto, explica sus fases y enlaza a mis redes profesionales.",
    explicacion_ejercicio:
      "Crea una landing page que sirva como tarjeta de visita online. Incluye tu nombre, una breve bio, fases del reto y enlaces a redes profesionales. Usa HTML semántico, CSS Flex/Grid y media queries para que sea responsive. Agrega animaciones suaves al hacer scroll o hover en los botones.",
    lenguajes: ["HTML", "CSS", "JavaScript"],
    imagen: "/assets_retos/reto1.png",
    links: [
    ...
    consejos:
      "Usa variables CSS para colores/fuentes; empieza con mobile‑first; valida enlaces con DevTools."
  },
  {
    id: 2,
    numero: 2,
    ...
    explicacion_ejercicio:
      "Construye una calculadora que realice operaciones básicas. Implementa un componente visual con botones, cálculo mediante eventos, control de errores como división por cero y reset. Añade historial básico si puedes.",
    lenguajes: ["HTML", "CSS", "JavaScript"],
    imagen: "/assets_retos/reto2.png",
    links: [
    ...
    consejos:
      "Separa la lógica de cálculo en funciones independientes; usa parseFloat y limita decimales; actualiza el UI tras cada acción."
  },
  {
    id: 3,
    numero: 3,
    ...
    explicacion_ejercicio:
      "Implementa un botón que genere un color hexadecimal aleatorio y lo aplique al fondo. Muestra el código y añade un botón para copiarlo al portapapeles. Agrega transición suave al cambio de color.",
    lenguajes: ["HTML", "CSS", "JavaScript"],
    imagen: "/assets_retos/reto3.png",
    links: [
    ...
    consejos:
      "Usa Math.random(); pon filtros de legibilidad si el color es muy oscuro/claro; añade transiciones en CSS."
  },
  {
    id: 4,
    numero: 4,
    nombre: "Conversor de divisas (estático)",
    descripcion_corta: "Convierte entre 2–3 monedas usando tasas predefinidas.",
    explicacion_ejercicio:
      "Crea campos de cantidad y selects para monedas. Al cambiar cualquiera, convierte usando tasas almacenadas en un objeto en JS. Añade validación y formatea el resultado.",
    lenguajes: ["HTML", "CSS", "JavaScript"],
    imagen: "/assets_retos/reto4.png",
    links: [
      "https://www.youtube.com/watch?v=HGTJBPNC-Gw",
      "#",
      "#",
    ...
    consejos:
      "Guarda tasas en constantes; usa toFixed(2); maneja inputs vacíos y no numéricos."
  },
  {
    id: 5,
    numero: 5,
    nombre: "Lista de tareas (LocalStorage)",
    ...
    consejos:
      "Envuelve en JSON.stringify/parse; actualiza el storage en cada cambio; maneja Borrar Todo."
  },
  {
    id: 6,
    numero: 6,
    ...
    consejos:
      "Usa pattern y required en HTML y refuerza con JS; muestra mensajes personalizados junto a inputs; evita recarga anunciada."
  },
  {
    id: 7,
    numero: 7,
    nombre: "Piedra, papel o tijeras",
    descripcion_corta: "Juego interactivo para jugar contra la máquina.",
    explicacion_ejercicio:
    ...
    consejos:
      "Guarda las opciones en un arreglo; haz la lógica de ganador como función separada; reinicia marcador opcional."
  },
  {
    id: 8,
    numero: 8,
    ...
    consejos:
      "Usa data-attributes para categorías; reutiliza la función de renderizado al cambiar filtro."
  },
  {
    id: 9,
    numero: 9,
    nombre: "Carrusel (slider)",
    descripcion_corta: "Slider de imágenes con control de anterior/siguiente.",
    explicacion_ejercicio:
  ...
  },
  {
    ...
    lenguajes: ["HTML", "CSS", "JavaScript"],
    imagen: "/assets_retos/reto10.png",
    links: [
      "https://www.youtube.com/watch?v=HGTJBPNC-Gw",
      "#",
      "#",
    ...
    consejos:
      "Include uppercase/lowercase/numbers/symbols según selección; usa Clipboard API."
  },
{
    id: 11, numero: 11, nombre: "Progress Bar Animation",
    ...
    lenguajes:["HTML","CSS","JavaScript"],
    imagen:"/assets_retos/reto11.png",
  ...
  {
    id: 12, numero: 12, nombre: "Landing Page Clone",
    ...
    lenguajes:["HTML","CSS","JavaScript"],
    imagen:"/assets_retos/reto12.png",
  ...
  {
    id: 13, numero: 13, nombre: "App del clima (API)",
  ...
  {
    id: 17, numero: 17, nombre: "News App (API)",
  ...
  },
  {
    ...
    imagen:"/assets_retos/reto32.png",
    links:["https://www.youtube.com/watch?v=GuA0_Z1llYU","#","#","#"],
    consejos:"useEffect para fetch; estado loading y error."
  },
  {
    id: 33, numero: 33, nombre: "Movie Search App (React + API)",
  ...
  {
    id: 34, numero: 34, nombre: "CRUD App (React + LocalStorage)",
  ...
  },
  {
    ...
    imagen:"/assets_retos/reto49.png",
    links:["https://www.youtube.com/watch?v=CVpUuw9XSjY","#","#","#"],
    consejos:"Normaliza el estado; usa combineReducers."
  },
  {
    id: 50, numero: 50, nombre: "Trello Clone (Drag & Drop)",
  ...
  },
  {
    ...
    imagen:"/assets_retos/reto51.png",
    links:["https://www.youtube.com/watch?v=zQyrwxMPm88","#","#","#"],
    consejos:"Eliminal mensajes duplicados; scroll to bottom auto."
  },
  {
    id: 52, numero: 52, nombre: "OAuth Login (Google/GitHub)",
  ...
  },
  {
    ...
    lenguajes:["React","Node.js","Express","JWT"],
    imagen:"/assets_retos/reto53.png",
    links:["#","#","#","#"],
    consejos:"Middleware de auth; pruebas con distintos tokens."
  },
  {
    id: 54, numero: 54, nombre: "WebSockets en proyecto",
    ...
    imagen:"/assets_retos/reto54.png",
    links:["https://www.youtube.com/watch?v=vQjiN8Qgs3c", "#", "#", "#"],
    consejos:"Usa rooms; desconexión limpia."
  },
  {
    id: 55, numero: 55, nombre: "E‑commerce Cart (React + Redux + Node)",
    ...
    imagen:"/assets_retos/reto55.png",
    links:["#","#","#","#"],
    consejos:"Normalized state; total price recalculado al cambiar cantidad."
  },
  {
    id: 56, numero: 56, nombre: "Netflix Clone (React + API)",
    ...
    imagen:"/assets_retos/reto56.png",
    links:["#","#","#","#"],
    consejos:"Optimiza carga de imágenes; paginar secciones."
  },
  {
    id: 57, numero: 57, nombre: "Sales App (Node.js + MongoDB)",
    ...
    imagen:"/assets_retos/reto57.png",
    links:["#","#","#","#"],
    consejos:"Populate en Mongoose; validar datos con JOI."
  },
  {
    id: 58, numero: 58, nombre: "Event Calendar App",
  ...
  },
  {
    ...
    imagen:"/assets_retos/reto59.png",
    links:["#","#","#","#"],
    consejos:"Protege rutas; divide contenido por módulos."
  },
  {
    id: 60, numero: 60, nombre: "Final Project Showcase",
    ...
    imagen:"/assets_retos/reto60.png",
    links:["#","#","#","#"],
